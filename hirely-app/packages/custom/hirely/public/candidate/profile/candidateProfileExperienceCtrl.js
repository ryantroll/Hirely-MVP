...
(function () {
    ...
    angular.module('mean.hirely.candidate').controller('CandidateProfileExperienceCtrl', ['$scope','$state','$stateParams', 'CandidateService', 'OccupationService', 'GeocodeService', '$timeout', CandidateProfileExperienceCtrl ]);
