...
(function () {
    ...
    function JobApplicationService($q, HirelyApiService) {
        ...
        var statusLabels = ['Started', 'Pending', 'Applied', 'Liked', 'Hired', 'Dismissed', 'ProfileStarted'];
        var statusLabelsHm = ['Started', 'Pending', 'Applied', 'Liked', 'Hired', 'Dismissed', 'ProfileStarted'];
